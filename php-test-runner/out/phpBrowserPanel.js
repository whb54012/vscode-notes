...
exports.PhpBrowserPanel = void 0;
...
class PhpBrowserPanel {
    constructor() {
        ...
        this.history = [];
        this.historyIndex = -1;
        this.serverManager = phpServerManager_1.PhpServerManager.getInstance();
        // 监听服务器状态变化
    ...
    show() {
        ...
        this.panel = vscode.window.createWebviewPanel('phpBrowser', 'PHP测试浏览器', vscode.ViewColumn.Beside, {
            enableScripts: true,
            retainContextWhenHidden: true,
            localResourceRoots: [],
        });
        this.panel.iconPath = vscode.Uri.parse('data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><text y="18" font-size="18">🐘</text></svg>'));
        // 监听面板关闭
    ...
    async openFile(filePath) {
        ...
        if (!this.serverManager.isRunning()) {
            try {
                ...
                vscode.window.showErrorMessage(`无法启动PHP服务器: ${err instanceof Error ? err.message : String(err)}`);
                return;
            }
        }
...
exports.PhpBrowserPanel = PhpBrowserPanel;
//# sourceMappingURL=phpBrowserPanel.js.map